        ...
        <div className="grid grid-cols-4 md:grid-cols-4 justify-center items-start gap-1 md:gap-5 m-[1rem]">  
          ...
          <ParticleCard>
            <div className="flex flex-col items-center justify-top w-[100%] h-fit p-[1rem] rounded-2xl border-4 border-purple-950/25 bg-gradient-to-br from-gray-800/80 to-gray-900/60 shadow-lg transition-transform hover:border-cyan-700">
              <span className="text-[1rem] md:text-[2rem] font-semibold text-white text-center mb-[1rem]"> Operating Systems</span>
          ...
          <ParticleCard>
            <div className="flex flex-col items-center justify-top w-[100%] p-[1rem] h-fit rounded-2xl border-4 border-purple-950/25 bg-gradient-to-br from-gray-800/80 to-gray-900/60 shadow-lg transition-transform hover:border-cyan-700">
              <span className="text-[1rem] md:text-[2rem]  font-semibold text-white text-center mb-[1rem] ">PY Stack</span>
                <div className="">
                    <Icons.PythonIcon/>
                </div>
              <span className="text-[0.8rem] md:text-[1rem] text-center text-white pt-[1rem] pb-[0.5rem] ">Frameworks and librarys</span>
              <div className="flex flex-col md:flex-row gap-1 ">
          ...
          <ParticleCard>
            <div className="flex flex-col items-center justify-top w-[100%] h-fit  p-[1rem] rounded-2xl border-4 border-purple-950/25 bg-gradient-to-br from-gray-800/80 to-gray-900/60 shadow-lg transition-transform hover:border-cyan-700">
              <span className="text-[1rem] md:text-[2rem] font-semibold text-white text-center mb-[1rem] ">JS Stack</span>
                <div className="flex flex-col md:flex-row gap-1 ">
          ...
          <ParticleCard>
            <div className="flex flex-col items-center justify-top w-[100%] h-fit p-[1rem] rounded-2xl border-4 border-purple-950/25 bg-gradient-to-br from-gray-800/80 to-gray-900/60 shadow-lg transition-transform hover:border-cyan-700">
              <span className="text-[1rem] md:text-[2rem] font-semibold text-white text-center mb-[1rem]">Databases</span>
                <div className="flex flex-col md:flex-row gap-1 ">
              ...
              <span className="text-[1rem] md:text-[2rem] text-center text-white pt-[1rem] pb-[0.5rem]">Data analysis</span>
                <div className="flex flex-col md:flex-row gap-1  ">
                  <Icons.ExcelIcon/>
                  <Icons.PowerbiIcon/>
                  <Icons.KnimeLogo/>
